...
class TestFriends < MiniTest::Test
  ...
  def test_particular_food
    result1 = likes_to_eat(@person2, "bread")
    result2 = likes_to_eat(@person3, "spinach")
  ...
  def test_everyone_snacks
    result = everyone_snacks(@people)
